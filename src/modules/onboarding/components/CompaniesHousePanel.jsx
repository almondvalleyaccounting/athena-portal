    ...
    <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 12, padding: '16px 18px', fontFamily: font }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
        ...
        <button
          ...
          style={{ marginLeft: 'auto', display: 'inline-flex', alignItems: 'center', gap: 4, background: 'none', border: 'none', color: '#0e7fe0', fontSize: 13, fontWeight: 600, cursor: 'pointer', fontFamily: font, padding: 0 }}
        >
            ...
            <div style={{ marginTop: 12 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                {ch.officers.map((o) => {
                  ...
                  return (
                    <div key={o.name} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13.5, color: '#334155' }}>
