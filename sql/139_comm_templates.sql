...
<p style="margin:0 0 14px;">If you make Self Assessment payments on account, your next one is due by <strong>31 July</strong>. You can see exactly what HMRC expects &mdash; your current balance, payments already made, and anything overdue &mdash; in your HMRC account at <a href="{{pay_url}}" style="color:#0e7fe0;">{{pay_url}}</a>.</p>
...
If you make Self Assessment payments on account, your next one is due by 31 July. You can see exactly what HMRC expects — your current balance, payments already made, and anything overdue — in your HMRC account at {{pay_url}}.
...
<p style="margin:0 0 14px;">Please note this is the figure from your return. What HMRC actually shows can differ if you have overdue amounts, penalties or interest from late payments &mdash; you can always check your balance at <a href="{{pay_url}}" style="color:#0e7fe0;">{{pay_url}}</a>.</p>
...
<p style="margin:0 0 14px;">Your payment reference is your UTR followed by the letter K. Other ways to pay are listed at <a href="{{pay_url}}" style="color:#0e7fe0;">{{pay_url}}</a>.</p>
...
Please note this is the figure from your return. What HMRC actually shows can differ if you have overdue amounts, penalties or interest from late payments — you can always check your balance at {{pay_url}}.
...
Your payment reference is your UTR followed by the letter K. Other ways to pay are listed at {{pay_url}}.
